...
with open('birthday.cvs', 'r') as csv_file:
...
with open('birthday.cvs', 'w') as birthday:
    ...
    birthday_writer.writerows([['Mykita','Twister','backend',2], ['Missis','Porrige','DevOps',7]])
...
with open('birthday2.csv', 'w') as birthday:
    ...
    birthday_dict_writer.writerows([{'name':'Mykita', 'surname': 'Twister', 'group': 'backend', 'birthday': 2},
